                ...
                with self._client() as client:
                    ...
                    send_resp = client.post(
                        ...
                        json={
                            ...
                            "refs": [{"kind": "text", "title": "medical_context", "text": "hidden ctx"}],
                        },
                    )
                    ...
                    self.assertEqual((((send_event.get("data") or {}).get("refs")) or [])[0]["title"], "medical_context")
                    ...
                    reply_resp = client.post(
                        ...
                        json={
                            ...
                            "refs": [{"kind": "text", "title": "medical_context", "text": "reply hidden"}],
                        },
                    )
                    ...
                    self.assertEqual((((reply_event.get("data") or {}).get("refs")) or [])[0]["text"], "reply hidden")
        finally:
            cleanup()
                ...
                with self._client() as client:
                    ...
                    send_upload_resp = client.post(
                        ...
                        data={
                            ...
                            "refs_json": "[{\"kind\":\"text\",\"title\":\"medical_context\",\"text\":\"upload hidden\"}]",
                        },
                    ...
                    self.assertEqual((((send_upload_event.get("data") or {}).get("refs")) or [])[0]["text"], "upload hidden")
                    ...
                    reply_upload_resp = client.post(
                        ...
                        data={
                            ...
                            "refs_json": "[{\"kind\":\"text\",\"title\":\"medical_context\",\"text\":\"upload reply hidden\"}]",
                        },
                    ...
                    self.assertEqual((((reply_upload_event.get("data") or {}).get("refs")) or [])[0]["text"], "upload reply hidden")
        finally:
            cleanup()
