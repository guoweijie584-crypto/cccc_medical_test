...
const proxyHost = (process.env.CCCC_WEB_HOST || "127.0.0.1").trim() || "127.0.0.1";
const rawProxyPort = Number.parseInt(process.env.CCCC_WEB_PORT || "", 10);
const proxyPort = Number.isFinite(rawProxyPort) && rawProxyPort > 0 ? rawProxyPort : 8858;
