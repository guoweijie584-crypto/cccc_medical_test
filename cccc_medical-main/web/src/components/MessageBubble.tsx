...
import { stripPatientMetadata } from "../utils/chatMetadata";
...
function formatEventLine(ev: LedgerEvent): string {
    if (ev.kind === "chat.message" && ev.data && typeof ev.data === "object") {
        ...
        return stripPatientMetadata(String(msg.text || ""));
    }
    return "";
}
...
export const MessageBubble = memo(function MessageBubble({
    ...
    const quoteText = stripPatientMetadata(String(msgData?.quote_text || ""));
