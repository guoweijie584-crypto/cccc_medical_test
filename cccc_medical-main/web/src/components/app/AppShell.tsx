...
import { MedicalTab } from "../../pages/medical";
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className={`absolute inset-0 flex min-h-0 flex-col ${
              activeTab === "medical" ? "" : "invisible pointer-events-none"
            }`}
            aria-hidden={activeTab !== "medical"}
          >
            <ErrorBoundary>
              <MedicalTab isDark={isDark} isVisible={activeTab === "medical"} />
            </ErrorBoundary>
          </div>

          <div
            className={`absolute inset-0 flex min-h-0 flex-col ${
              activeTab === "chat" || activeTab === "medical" ? "invisible pointer-events-none" : ""
            }`}
            aria-hidden={activeTab === "chat" || activeTab === "medical"}
          >
